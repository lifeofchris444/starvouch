...
import { ArrowRight, Gift, Sparkles, Coffee } from "lucide-react";
  ...
  return (
    <section id="apply" ref={sectionRef} className="pt-10 pb-14 sm:pt-14 sm:pb-18 px-4 bg-card">
      <div className="max-w-4xl mx-auto">
        <div
          className={`relative bg-[#006241] rounded-3xl p-7 sm:p-10 text-center overflow-hidden transition-all duration-700 ease-out ${
        ...
        >
          ...
          <div className="relative z-10">
            ...
            >
              <a
                href="https://trksy.org/aff_c?offer_id=1741&aff_id=26188"
                target="_blank"
                rel="noopener noreferrer"
                className="touch-button group inline-flex items-center gap-3 bg-white text-[#006241] px-10 py-5 rounded-full text-lg font-semibold hover:bg-white/95 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1"
              >
                APPLY NOW
