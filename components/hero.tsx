  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto text-center">
        ...
        >
          Discover how people are saving on handcrafted drinks, fresh food, and the new Pink Starbucks Bear Cup.
        </p>
        ...
        >
          <a
            ...
            className="touch-button group inline-flex items-center gap-3 bg-[#006241] text-white px-8 py-4 rounded-full text-lg font-semibold hover:bg-[#00492f] transition-all duration-300 hover:shadow-xl hover:shadow-[#006241]/20 hover:-translate-y-0.5"
          >
            APPLY NOW
